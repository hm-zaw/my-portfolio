...
const NavBar = () => {
    return (
        <>
            {/* <!-- Navbar --> */}
            <nav id="nav" className="translate-y-auto sticky top-0 z-40 h-max w-full flex-1 justify-center bg-primary p-6 transition duration-500 lg:p-4">
                <div className="mx-auto max-w-6xl flex-col flex-wrap items-center justify-between text-primary">
                    <div className="flex flex-1 flex-wrap items-center font-open-sans">
                        {/* <!-- Nav Title --> */}
                        <button id="navLogo" type="button" className="z-50 inline-flex flex-1 gap-2 text-xl font-bold" >
                        ...
                        {/* <!-- Nav Menu --> */}
                        <div id="navMove" className="invisible fixed inset-0 z-40 flex-none basis-full translate-x-full bg-primary text-lg transition duration-500 lg:visible lg:relative lg:top-0 lg:basis-auto lg:translate-x-0 lg:transition-none">
                            <div className="flex h-full flex-col flex-nowrap items-center justify-center space-x-0 space-y-8 p-6 lg:flex lg:flex-row lg:justify-end lg:space-x-14 lg:space-y-0 lg:p-0">
                                ...
                                <button id="navMenuPortfolio" className="text-xl hover:text-secondary lg:text-base" >
                                    My Portofolio
                                </button>
                                <button id="navMenuContact" className="group inline-flex items-center gap-3 rounded-full border-2 border-primary px-8 py-4 hover:border-transparent hover:bg-senary hover:font-semibold hover:text-senary">
                                    GET IN TOUCH
                                    {/* <!-- Arrow top left --> */}
                        ...
                        <div className="z-50 flex-none">
                            <div className="flex justify-end lg:hidden">
                                <button id="navButton" className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-primary">
                                    {/* <!-- Open Icon --> */}
                                    <svg className="navMenuIcon block w-8 fill-primary" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
                                    ...
                                    {/* <!-- Close Icon --> */}
                                    <svg className="navMenuIcon hidden w-8 fill-primary" fill="none"
